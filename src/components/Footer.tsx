  ...
  return (
    <div>
        <div className="text-sm text-center p-2 border-t">
          ...
          <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://woordle-afr.netlify.app" target="_blank"><i className="fa-brands fa-linkedin-in p-1"></i></a></div>
        <div className="text-sm text-center bg-slate-200 p-2"><i className="fa-brands fa-react"></i> {new Date().getFullYear()}</div>
    </div>
  )
}
